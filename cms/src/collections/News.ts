...
export const News: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      admin: {
        position: 'sidebar',
        description: 'Surface in the homepage News block.',
      },
    },
    {
      name: 'sortOrder',
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: 'location',
          type: 'text',
          admin: { width: '50%', description: 'City, e.g. "Tourcoing".' },
        },
      ],
    },
    {
      ...
      fields: [
        {
          name: 'badgeLabel',
          type: 'text',
          admin: { width: '50%', description: 'e.g. "Retrospective", "Biennale".' },
        },
        {
          name: 'badgeStyle',
          type: 'select',
    ...
    },
    {
      name: 'venue',
      type: 'richText',
      admin: { description: 'Venue line including curator (rendered above the excerpt).' },
    },
    {
      name: 'excerpt',
      type: 'textarea',
    ...
    },
    {
      name: 'body',
      type: 'richText',
      admin: { description: 'Full article body for the detail page.' },
    },
  ],
}
